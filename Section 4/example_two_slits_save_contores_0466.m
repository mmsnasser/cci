% example_two_slits_save_contores_0466.m
% Nasser, June 11, 2019
clc;clear; 
%
% To generate the data files 
% x04_pt.mat, y04_pt.mat, u0466_pt.mat
% which used by the file
% example_two_slits_plot_contores_0466.m
% to plot Figure 18 in Section 7 of the paper:
...
save('u0466_pt.mat', 'u',    '-ascii', '-double');
%
